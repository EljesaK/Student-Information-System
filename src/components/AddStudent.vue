  ...
  <div>
    <form @submit="addStudent" class="m-5 justify-content-center col">
      <div class="row">
        ...
        <input type="date" name="dob" v-model="dob" placeholder="Date of birth" class="m-3 p-2 form-control col">
      </div>

      <select name="municipality" v-model="municipality" id="" class="form-control m-3 p-2">
      ...
      <button type="submit" class="d-block m-3 ps-5 pe-5 btn btn-primary form-control">Save</button>
    </form>
  </div>
</template>
